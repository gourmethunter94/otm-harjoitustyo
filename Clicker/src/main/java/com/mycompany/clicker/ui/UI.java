...
public class UI {
    ...
    /**
     *Sets active status of the UI; active UI is visible and updates, while inactive is invisible and doesn't update.
     * @param value boolean
     */
    ...
    /**
     *Updates all active elements of the UI (spesific elements might be set to inactive.
     */
    public void update(){
        for(UIElement uie : uiElements){
